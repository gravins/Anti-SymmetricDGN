...
from .antisymmetric_dgn import *

class GraphModel(torch.nn.Module):
    def __init__(self, gnn_type, num_layers, dim0, h_dim, out_dim, epsilon, activ_fun, gamma, ##### A-DGN
        ...
        self.layer = AntiSymmetricConv(h_dim, num_iters=self.num_layers, epsilon=self.epsilon, gamma=gamma, activ_fun=activ_fun, gcn_conv=False) ##### A-DGN
        #if unroll:
